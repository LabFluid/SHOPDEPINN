...
# ╔═╡ 0fa7ce90-c871-11ef-1806-993774da8af1
begin
	using Plots, JLD
end

# ╔═╡ 3a5bd3fb-646b-4891-a242-7cdce95fa682
md"$\begin{align}
...
# ╔═╡ 322756b4-9f8f-4cba-84c5-90eec7281c2c
...
# ╔═╡ 1413c0c3-f38b-47a5-8e6e-b84c6c24aa89
begin
...
# ╔═╡ 73c91c8e-54bc-4cd6-ba18-79f36aecc4a8
heatmap(x, t, u, title="Upwind")

# ╔═╡ e1555f7a-0da8-4a09-aa41-f8149b7c38a3
begin
	Upwind_Dados = zeros(length(u),3)
	k = 1
	for i = 1:length(t)
		for j = 1:length(x)
			Upwind_Dados[k,1] = x[j]
			Upwind_Dados[k,2] = t[i]
			Upwind_Dados[k,3] = u[i,j]
			k = k + 1
		end
	end
	Upwind_Dados
...
# ╔═╡ d4f368a7-aa81-4dc6-9b5c-6aefd70ebf68
begin
	save("Upwind_Dados.jld", "Upwind_Dados", Upwind_Dados, "x", x, "t", t, "u_upwind", u)
end
...
manifest_format = "2.0"
project_hash = "2826c0154202d39f2d5da8bbea145fc8e724f7de"
